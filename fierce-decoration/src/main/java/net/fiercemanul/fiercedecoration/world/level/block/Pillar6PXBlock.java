...
public class Pillar6PXBlock extends AxisModelBlock {


    public static final MapCodec<Pillar6PXBlock> CODEC = simpleCodec(Pillar6PXBlock::new);

    private static final VoxelShapeHelper SHAPE_HELPER = new VoxelShapeHelper()
            .applyCube(5.0, 5.0, 0.0, 11.0, 11.0, 16.0);
    ...
    public Pillar6PXBlock(Properties pProperties) {
        super(pProperties);
    }

    @Override
    protected MapCodec<? extends Pillar6PXBlock> codec() {
        return CODEC;
    }
