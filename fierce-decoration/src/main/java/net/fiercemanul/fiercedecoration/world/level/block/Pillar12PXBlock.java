...
public class Pillar12PXBlock extends AxisModelBlock {


    public static final MapCodec<Pillar12PXBlock> CODEC = simpleCodec(Pillar12PXBlock::new);

    private static final VoxelShapeHelper SHAPE_HELPER = new VoxelShapeHelper()
            .applyCube(2.0, 2.0, 0.0, 14.0, 14.0, 16.0);
    ...
    public Pillar12PXBlock(Properties pProperties) {
        super(pProperties);
    }

    @Override
    protected MapCodec<? extends Pillar12PXBlock> codec() {
        return CODEC;
    }
