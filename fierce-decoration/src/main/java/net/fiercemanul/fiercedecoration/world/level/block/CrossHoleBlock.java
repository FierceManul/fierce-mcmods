...
public class CrossHoleBlock extends FacingDecorBlock {
    ...
    private static final VoxelShapeHelper SHAPE_HELPER = new VoxelShapeHelper()
            .applyCube(0.0D, 0.0D, 0.0D, 7.0D, 7.0D, 2.0D)
            .applyCube(9.0D, 0.0D, 0.0D, 16.0D, 7.0D, 2.0D)
            .applyCube(0.0D, 9.0D, 0.0D, 7.0D, 16.0D, 2.0D)
            .applyCube(9.0D, 9.0D, 0.0D, 16.0D, 16.0D, 2.0D)
            .applyCube(7.0D, 0.0D, 0.0D, 9.0D, 3.0D, 2.0D)
            .applyCube(0.0D, 7.0D, 0.0D, 3.0D, 9.0D, 2.0D)
            .applyCube(13.0D, 7.0D, 0.0D, 16.0D, 9.0D, 2.0D)
            .applyCube(7.0D, 13.0D, 0.0D, 9.0D, 16.0D, 2.0D);
    ...
    private static final VoxelShapeHelper COLLISION_SHAPE_HELPER = new VoxelShapeHelper()
            .applyCube(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 2.0D);
