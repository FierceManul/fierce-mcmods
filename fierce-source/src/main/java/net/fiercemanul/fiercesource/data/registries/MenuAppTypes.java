...
import net.fiercemanul.fiercesource.server.level.app.TestServerMenuApp;
...
import static net.fiercemanul.fiercesource.data.registries.FCRegistries.MENU_APP_TYPES;

public class MenuAppTypes {


    public static final DeferredHolder<MenuAppType<?>, MenuAppType<TestServerMenuApp>> TEST = register(
            "test", TestServerMenuApp.ENCODER, () -> TestClientMenuApp.DECODER);
