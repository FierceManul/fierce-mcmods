...
import static net.fiercemanul.fiercesource.data.FSItems.TEST_ITEM;
...
public final class FSCreativeModeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab>
            MAIN_TAB = FCRegistries.CREATIVE_MODE_TABS.register(
    ...
    public static void init() {
        ...
        TAB_ITEMS.add(new CreativeModeTabItem(SMOOTH_HAO_STONE, getPriority()));
        TAB_ITEMS.add(new CreativeModeTabItem(DEEP_STONE, getPriority()));
        TAB_ITEMS.add(new CreativeModeTabItem(POLISHED_DEEP_STONE, getPriority()));
        TAB_ITEMS.add(new CreativeModeTabItem(SMOOTH_DEEP_STONE, getPriority()));
    }
