...
public final class FSBlocks {
    ...
    public static final ItemBlockGroup<CreativeManaOutputBlock, BlockItem>
            CREATIVE_MANA_OUTPUT = simpleBlockItem("creative_mana_output", CreativeManaOutputBlock::new, BlockBehaviour.Properties.of().strength(2.0F, 1200.0F).lightLevel(value -> 15).emissiveRendering(FSUtils::getTrue).sound(SoundType.AMETHYST).mapColor(MapColor.COLOR_BLUE));
    ...
    //方块化物品
    public static final ItemBlockGroup<RotationWaterlogBlock, BlockItem>
            SOUL_CRYSTAL_SHARD = simpleBlockItem("soul_crystal_shard", RotationWaterlogBlock::new, BlockBehaviour.Properties.of().instabreak().noCollission().pushReaction(PushReaction.DESTROY).noOcclusion().sound(SoundType.LARGE_AMETHYST_BUD).mapColor(MapColor.WOOL));
