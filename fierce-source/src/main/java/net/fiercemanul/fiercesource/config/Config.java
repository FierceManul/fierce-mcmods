...
public class Config {
    ...
    public static final ModConfigSpec.BooleanValue FORCE_MANA_CONSUME = BUILDER
            .comment("是否无主模块时依然消耗灵能")
            .define("forceManaConsume", false);
    public static final ModConfigSpec.BooleanValue THROWN_BLOCK_SAVE_MODE = BUILDER
