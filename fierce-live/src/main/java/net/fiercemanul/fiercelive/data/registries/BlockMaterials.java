...
public final class BlockMaterials {
    ...
    public static final BlockMaterial SMOOTH_OAK_PLANKS = regPlanks(FLBlocks.SMOOTH_OAK_PLANKS, MapColorHolders.WOOD, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_SPRUCE_PLANKS = regPlanks(FLBlocks.SMOOTH_SPRUCE_PLANKS, MapColorHolders.PODZOL, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_BIRCH_PLANKS = regPlanks(FLBlocks.SMOOTH_BIRCH_PLANKS, MapColorHolders.SAND, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_JUNGLE_PLANKS = regPlanks(FLBlocks.SMOOTH_JUNGLE_PLANKS, MapColorHolders.DIRT, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_ACACIA_PLANKS = regPlanks(FLBlocks.SMOOTH_ACACIA_PLANKS, MapColorHolders.COLOR_ORANGE, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_DARK_OAK_PLANKS = regPlanks(FLBlocks.SMOOTH_DARK_OAK_PLANKS, MapColorHolders.COLOR_BROWN, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_MANGROVE_PLANKS = regPlanks(FLBlocks.SMOOTH_MANGROVE_PLANKS, MapColorHolders.COLOR_RED, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_BAMBOO_PLANKS = regPlanks(FLBlocks.SMOOTH_BAMBOO_PLANKS, MapColorHolders.COLOR_YELLOW, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_CHERRY_PLANKS = regPlanks(FLBlocks.SMOOTH_CHERRY_PLANKS, MapColorHolders.TERRACOTTA_WHITE, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_CRIMSON_PLANKS = regPlanks(FLBlocks.SMOOTH_CRIMSON_PLANKS, MapColorHolders.CRIMSON_STEM, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial SMOOTH_WARPED_PLANKS = regPlanks(FLBlocks.SMOOTH_WARPED_PLANKS, MapColorHolders.WARPED_STEM, SMOOTH_PLANK_TAGS);
    ...
    public static final BlockMaterial CUT_SANDSTONE = mc(Blocks.CUT_SANDSTONE, MapColorHolders.SAND, CUT_SANDSTONE_TAGS);
    ...
    public static final BlockMaterial CUT_RED_SANDSTONE = mc(Blocks.CUT_RED_SANDSTONE, MapColorHolders.COLOR_ORANGE, CUT_SANDSTONE_TAGS);
    ...
    //public static final BlockMaterial COPPER_BLOCK = mcFixId(Blocks.COPPER_BLOCK, "_block", MapColorHolders.COLOR_ORANGE, POLISHED_TAGS);
    //public static final BlockMaterial BONE_BLOCK = mcFixId(Blocks.BONE_BLOCK, "_block", MapColorHolders.SAND, PILLAR_TAGS);
    ...
    public static final BlockMaterial RAINBOW_CONCRETE = reg(FLBlocks.RAINBOW_CONCRETE, MapColorHolders.SNOW, COLOR_ARTIFICIAL_STONE_TAGS);
    ...
    public static final BlockMaterial RAINBOW_WOOL = reg(FLBlocks.RAINBOW_WOOL, MapColorHolders.SNOW, WOOL_TAGS);
    ...
    public static final BlockMaterial RAINBOW_GLASS = reg(FLBlocks.RAINBOW_GLASS, MapColorHolders.SNOW, STAINED_GLASS_TAGS);

    public static final HashSet<BlockMaterialTag> LAMP_TAGS = new HashSet<>();
    public static final HashSet<BlockMaterialTag> HARD_LAMP_TAGS = new HashSet<>();
    ...
    public static final HashSet<BlockMaterialTag> COLOR_HARD_LAMP_TAGS = new HashSet<>();
    ...
    public static final BlockMaterial GLOWSTONE_LAMP = reg(FLBlocks.GLOWSTONE_LAMP, MapColorHolders.SAND, LAMP_TAGS);
    public static final BlockMaterial SEA_LANTERN = mc(Blocks.SEA_LANTERN, MapColorHolders.QUARTZ, SEA_LANTERN_TAGS);
    public static final BlockMaterial RAINBOW_SEA_LANTERN = reg(FLBlocks.RAINBOW_SEA_LANTERN, MapColorHolders.SNOW, COLOR_LAMP_TAGS);
    ...
    public static final BlockMaterial RED_LAMP = reg(FLBlocks.RED_LAMP, MapColorHolders.COLOR_RED, COLOR_HARD_LAMP_TAGS);
    public static final BlockMaterial GREEN_LAMP = reg(FLBlocks.GREEN_LAMP, MapColorHolders.COLOR_GREEN, COLOR_HARD_LAMP_TAGS);
    public static final BlockMaterial BLUE_LAMP = reg(FLBlocks.BLUE_LAMP, MapColorHolders.COLOR_BLUE, COLOR_HARD_LAMP_TAGS);
    public static final BlockMaterial YELLOW_LAMP = reg(FLBlocks.YELLOW_LAMP, MapColorHolders.COLOR_YELLOW, COLOR_HARD_LAMP_TAGS);
    public static final BlockMaterial CYAN_LAMP = reg(FLBlocks.CYAN_LAMP, MapColorHolders.COLOR_CYAN, COLOR_HARD_LAMP_TAGS);
    public static final BlockMaterial PURPLE_LAMP = reg(FLBlocks.PURPLE_LAMP, MapColorHolders.COLOR_PURPLE, COLOR_HARD_LAMP_TAGS);
    public static final BlockMaterial RAINBOW_LAMP = reg(FLBlocks.RAINBOW_LAMP, MapColorHolders.SNOW, COLOR_HARD_LAMP_TAGS);
    ...
    private static BlockMaterial mcPlanks(Block block, MapColorHolder mapColorHolder, HashSet<BlockMaterialTag> tags) {
        ...
        return BlockBulkRegister.registerBlockMaterial(new BlockMaterial(
                ResourceLocation.fromNamespaceAndPath(FierceLive.MODID, rlb.getPath().replace("_planks", "")),
                rlb,
                () -> block,
    ...
    private static BlockMaterial mcFixId(Block block, String removedIdPath, MapColorHolder mapColorHolder, HashSet<BlockMaterialTag> tags) {
        ResourceLocation rlb = BuiltInRegistries.BLOCK.getKey(block);
        return BlockBulkRegister.registerBlockMaterial(new BlockMaterial(
                ResourceLocation.fromNamespaceAndPath(FierceLive.MODID, rlb.getPath().replace(removedIdPath, "")),
                rlb,
                () -> block,
                () -> BlockBehaviour.Properties.ofFullCopy(block),
                mapColorHolder,
    ...
    public static void init() {
        ...
        LOG_TAGS.add(BlockMaterialTag.TEXTURE_PILLAR);
        ...
        SMOOTH_PLANK_TAGS.add(BlockMaterialTag.SMOOTH_PLANKS);
        ...
        PILLAR_DIRT_TAGS.add(BlockMaterialTag.TEXTURE_PILLAR);
        ...
        NYLIUM_TAGS.add(BlockMaterialTag.TEXTURE_UP_DOWN);
        ...
        NATURE_PILLAR_TAGS.add(BlockMaterialTag.TEXTURE_PILLAR);
        ...
        SANDSTONE_TAGS.add(BlockMaterialTag.TEXTURE_UP_DOWN);
        ...
        natureToArtificial(CHISELED_SANDSTONE_TAGS);
        tagReplace(CHISELED_SANDSTONE_TAGS, BlockMaterialTag.TEXTURE_UP_DOWN, BlockMaterialTag.TEXTURE_CHISELED);

        CUT_SANDSTONE_TAGS.addAll(SANDSTONE_TAGS);
        natureToArtificial(CUT_SANDSTONE_TAGS);

        SMOOTH_SANDSTONE_TAGS.addAll(SMOOTH_TAGS);
        natureToArtificial(SMOOTH_SANDSTONE_TAGS);
        ...
        HARD_LAMP_TAGS.addAll(LAMP_TAGS);
        HARD_LAMP_TAGS.add(BlockMaterialTag.TOOL_PICKAXE);
        ...
        COLOR_HARD_LAMP_TAGS.addAll(COLOR_LAMP_TAGS);
        COLOR_HARD_LAMP_TAGS.add(BlockMaterialTag.TOOL_PICKAXE);
