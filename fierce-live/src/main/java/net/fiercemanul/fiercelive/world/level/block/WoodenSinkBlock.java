...
public class WoodenSinkBlock extends SinkBlock {


    public static final MapCodec<WoodenSinkBlock> CODEC = simpleCodec(WoodenSinkBlock::new);
    protected static final VoxelShapeHelper SHAPE = new VoxelShapeHelper()
            .applyCube(0, 4, 2, 16, 16, 16)
            .applyCube(0, 0, 2, 1, 4, 16)
            .applyCube(15, 0, 2, 16, 4, 16);
    ...
    public WoodenSinkBlock(Properties properties) {
        super(properties);
    }
    ...
    @Override
    public MapCodec<? extends WoodenSinkBlock> codec() {
        return CODEC;
    }
