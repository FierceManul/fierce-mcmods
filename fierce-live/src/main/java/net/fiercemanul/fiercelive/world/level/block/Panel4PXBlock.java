...
public class Panel4PXBlock extends FacingWaterloggedBlock {


    public static final MapCodec<? extends Panel4PXBlock> CODEC = simpleCodec(Panel4PXBlock::new);
    private static final VoxelShapeHelper SHAPE_HELPER = new VoxelShapeHelper().applyCube(0.0, 0.0, 0.0, 16.0, 16.0, 4.0);
    ...
    public Panel4PXBlock(Properties properties) {
        super(properties);
    }

    @Override
    protected MapCodec<? extends Panel4PXBlock> codec() {
        return CODEC;
    }
