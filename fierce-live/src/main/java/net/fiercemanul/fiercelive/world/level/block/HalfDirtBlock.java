...
public class HalfDirtBlock extends HalfPodzolBlock {
    ...
    private static final Map<Block, BlockState> BLOCK_MAP = ImmutableMap
            ...
            .put(Blocks.GRASS_BLOCK, FLBlocks.HALF_GRASS_BLOCK.get().defaultBlockState())
            .put(FLBlocks.HALF_GRASS_BLOCK.get(), FLBlocks.HALF_GRASS_BLOCK.get().defaultBlockState())
            .put(Blocks.MYCELIUM, FLBlocks.HALF_MYCELIUM.get().defaultBlockState())
            .put(FLBlocks.HALF_MYCELIUM.get(), FLBlocks.HALF_MYCELIUM.get().defaultBlockState())
            .build();
