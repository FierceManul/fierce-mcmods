package net.fiercemanul.fiercelive.world.level.block.state.properties;
...
public enum TallBlockType implements StringRepresentable {
    ...
    public TallBlockType unConnect(Direction facing) {
    ...
    public TallBlockType connect(Direction facing) {
        if (facing.equals(Direction.UP)) {
            return switch(this) {
                case SINGLE -> BOTTOM;
                case TOP -> CENTER;
