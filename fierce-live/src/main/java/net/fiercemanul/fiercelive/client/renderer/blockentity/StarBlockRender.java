package net.fiercemanul.fiercelive.client.renderer.blockentity;
...
@OnlyIn(Dist.CLIENT)
public class StarBlockRender implements BlockEntityRenderer<BlockEntity> {


    private final static RenderType LINE_IN = RenderType.itemEntityTranslucentCull(FSUtils.rl(FierceLive.MODID, "textures/entity/mana_transmit_in.png"));
    private final static RenderType LINE_OUT = RenderType.itemEntityTranslucentCull(FSUtils.rl(FierceLive.MODID, "textures/entity/mana_transmit_out.png"));

    public StarBlockRender(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(BlockEntity starBlock, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
